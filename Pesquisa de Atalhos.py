...
raiz = ['C:/Users/%%%% ESCREVA SEU USUARIO %%%%/AppData/Roaming/Microsoft/Windows/Start Menu',
        'C:/ProgramData/Microsoft/Windows/Start Menu/Programs']
saida = 'C:/Users/%%%% ESCREVA SEU USUARIO %%%%/Desktop'
...
fala = 'solidworks'  # -----------------------------------------------> string de pesquisa
